...
const EstimateFeesOutputSchema = z.object({
  courtName: z.string().describe("The name of the likely small claims court. If a specific courthouse cannot be found, provide the name of the county court (e.g., 'Los Angeles County Superior Court')."),
