...
import { MapPin, Building, Phone, Info, Loader2 } from "lucide-react";
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="flex gap-4">
                        ...
                        <Button type="submit" disabled={isLoading}>
                            {isLoading ? (
                                <><Loader2 className="mr-2 h-4 w-4 animate-spin" /> {t(text.searching)}</>
                            ) : (
                                t(text.findCourt)
                            )}
                        </Button>
                 ...
                 {isLoading && !courtInfo && (
                     <div className="text-center p-4 mt-4">
                        ...
                        <p className="text-muted-foreground mt-2">{t(text.searching)}</p>
                    </div>
                )}
