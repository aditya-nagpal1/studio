...
const text = {
    ...
    caseDetailsPlaceholder: { en: "Explain what happened, who was involved, and what evidence you have (ex: texts, photos, contracts).", es: "Explique qué sucedió, quién estuvo involucrado y qué evidencia tiene (por ejemplo, textos, fotos, contratos)." },
    desiredOutcome: { en: "What is your desired outcome?", es: "Cuál es el resultado deseado?" },
    desiredOutcomePlaceholder: { en: "ex: Get my security deposit of $800 back.", es: "ej., Recuperar mi depósito de seguridad de $800." },
